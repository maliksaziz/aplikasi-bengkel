        ...
        <div class="container-fluid">
            <div class="panel panel-headline">
                <div class="panel-heading">
                    <h3 class="panel-title"><b>Welcome {{ Auth::user()->name }}</b></h3>
                    <p class="panel-subtitle">Period: Oct 14, 2020 - Dec 21, 2020</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="metric">
                                ...
                                <p>
                                <span class="number">{{$dataspt}}</span>
                                <span class="title">Total Sparepart</span>
                                </p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="metric">
                                ...
                                <p>
                                <span class="number">{{$datamk}}</span>
                                <span class="title">Total Mekanik</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="metric">
                                        <span class="icon"><i class="lnr lnr-user"></i></span>
                                        <p>
                                            <span class="number">{{$dataus}}</span>
                                            <span class="title">Total Petugas</span>
                                        </p>
                                    </div>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Good Morning <b style="text-transform: capitalize;">{{ Auth::user()->name }}</b></h3>
            ...
            <div class="container-fluid">
                ...
                <div class="card-group">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium">{{$datamk}}</h2>
                                        
                                        <!-- <span
                                            class="badge bg-primary font-12 text-white font-weight-medium badge-pill ml-2 d-lg-block d-md-none">+18.33%</span> -->
                                    </div>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Mekanik</h6>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">{{$dataus}}</h2>
                                    
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Petugas
                                    </h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium">{{$dataspt}}</h2>
                                    </div>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Sparepart</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 font-weight-medium">{{$datapb}}</h2>
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Index Prestasi Mahasiswa</h4>
                                <div class="net-income mt-4 position-relative" style="height:294px;"></div>
                                <ul class="list-inline text-center mt-5 mb-2">
                                    <li class="list-inline-item text-muted font-italic">Dalam 6 bulan</li>
                                </ul>
                            </div>
                        </div>
                    </div> -->
