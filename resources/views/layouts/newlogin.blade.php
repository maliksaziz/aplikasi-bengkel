                ...
                <div class="auth-box ">
                        ...
                        <div class="content">
                            ...
                            <form class="form-auth-small" method="POST" action="/postlogin">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" value="thisisthepassword" required autocomplete="current-password" placeholder="Password">
                                ...
                                <div class="bottom">
                                    <span class="helper-text"><i class="fa fa-user"></i> <a href="/newregister">Create an account</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="right">
                        ...
                        <div class="content text">
                            <h1 class="heading">Aplikasi Bengkel</h1>
                            <p>by Malik Aziz</p>
                        </div>
                    </div>
